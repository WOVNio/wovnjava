...
#MAVEN    = docker run -i --rm -u 1000 -e MAVEN_CONFIG=/var/maven/.m2 -v ${TARGET_DIR}:/var/maven/.m2 -w /var/maven/.m2 maven:3-jdk-$(VERSION) mvn
WEBSITE_CONFIG_FILE = pom.jd8.xml
