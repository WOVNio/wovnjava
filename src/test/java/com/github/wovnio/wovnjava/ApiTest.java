...
public class ApiTest extends TestCase {
    ...
    public void testTranslateWithGzipResponse() throws ApiException, IOException, ProtocolException, SettingsException {
    ...
    public void testTranslateWithPlainTextResponse() throws ApiException, IOException, ProtocolException, SettingsException {
    ...
    private String testTranslate(byte[] apiServerResponse, String encoding) throws ApiException, IOException, ProtocolException, SettingsException {
        ...
        Headers headers = new Headers(request, settings, patternHandler);
