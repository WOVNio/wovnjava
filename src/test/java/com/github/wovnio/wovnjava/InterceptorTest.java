...
public class InterceptorTest extends TestCase {
    ...
    public void testApiTranslate() throws NoSuchMethodException, IllegalAccessException, IOException, ServletException, SettingsException {
    ...
    public void testApiTimeout() throws NoSuchMethodException, IllegalAccessException, IOException, ServletException, SettingsException {
    ...
    public void testNoApi() throws NoSuchMethodException, IllegalAccessException, IOException, ServletException, SettingsException {
        String originalHtml = "<!doctype html><html><head><meta http-equiv=\"CONTENT-TYPE\"><title>test</title></head><body>test</body></html>";
        Settings settings = TestUtil.makeSettings(new HashMap<String, String>() {{
            put("projectToken", "token0");
            put("defaultLang", "en");
    ...
    private String translate(String path, String html, Settings settings, Api api, ResponseHeaders responseHeaders) throws NoSuchMethodException, IllegalAccessException, IOException, ServletException, SettingsException {
        HttpServletRequest request = mockRequestPath(path);
        PatternHandler patternHandler = PatternHandlerFactory.create(settings);
        Interceptor interceptor = new Interceptor(new Headers(request, settings, patternHandler), settings, api, responseHeaders);
